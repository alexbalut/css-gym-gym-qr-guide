...
async function main() {
  console.log("Seeding Coop Sportive Santé...");
  ...
  const gym = await prisma.gym.create({
    data: {
      name: "Coop Sportive Santé",
      slug: "css-gym",
      tagline: "Coop governance gym",
      primaryColor: "#00897B",
      secondaryColor: "#0A1614",
      city: "Montréal, QC",
    },
  });
  ...
  console.log("   Gym: Coop Sportive Santé");
  console.log("   Login: admin@css-gym.demo / demo1234");
