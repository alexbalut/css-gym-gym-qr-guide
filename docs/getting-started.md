...
```bash
git clone https://github.com/alexbalut/css-gym-gym-qr-guide.git
...
Credentials: `admin@css-gym.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Coop Sportive Santé with 10 machines and sample issues/views.
